...
growth_plot <- ggplot(data = plant_gr, aes(x =soil.moisture.content, y = plant.growth.rate)) +
  geom_point() +
  theme_bw() +
  labs( y = "Plant Growth (mm/week)", x = bquote("Soil Moisture ("~cm^3/cm^3~")"))
growth_plot
```
...
- Significant 
- For each 1 cm<sup>3</sup>/cm<sup>3</sup> increase in soil moisture, plant growth rate is predicted to increase by 12.75 mm/week 
...
- A 95% confidence interval for plant growth rate at soil moisture content of 1 cm<sup>3</sup>/cm<sup>3</sup> would be 30.93 to 33.27 mm/week
...
- A 95% prediction interval for plant growth rate at soil moisture content of 1 cm<sup>3</sup>/cm<sup>3</sup> would be 23.93 to 40.26 mm/week
